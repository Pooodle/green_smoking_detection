...
void loop() {
  ...
  Serial.print("CO (unit ppm): "); Serial.print(ratio); Serial.print("   ");
  Serial.print("Dust Density(unit µg/m3): "); Serial.print(dustDensity); Serial.print("   ");
  Serial.print("HSensor: "); Serial.print(Hsensor * 100); Serial.print("   ");
